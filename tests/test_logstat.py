import unittest
from logstat.logstat import Config, LogLine
...
class TestLogStats(unittest.TestCase):
    ...
    def test_logline(self):
        legit_line = 'uplherc.upl.com - - [01/Aug/1995:00:00:07 -0400] "GET / HTTP/1.0" 304 10'
    ...
    def test_logline_missing_nbytes(self):
        legit_line = 'uplherc.upl.com - - [01/Aug/1995:00:00:07 -0400] "GET / HTTP/1.0" 304 '
        lg = LogLine(legit_line)
        print(lg.page)
        self.assertEqual(lg.host, "uplherc.upl.com")
        self.assertEqual(lg.time, "01/Aug/1995:00:00:07 -0400")
